...
We welcome respectful, specific, and constructive participation. Examples of positive behavior include showing empathy, respecting different experience levels, accepting feedback, and focusing on what is best for users and contributors.

Harassment, discrimination, sexualized conduct, personal attacks, deliberate privacy violations, publishing private correspondence, and sustained disruption are not acceptable.

## Scope

This standard applies to repository issues, pull requests, discussions, reviews, release channels, and public spaces where a person is representing the project.
